...
function App() {
  return (
    <div
     ...
     // backgroundImage:"url('https://thumbs.dreamstime.com/z/colourful-various-herbs-spices-cooking-dark-background-herbs-spices-cooking-dark-background-113655482.jpg')", 
      position: "absolute",
        display: "flex",
        overflow: "hidden"
      }}
